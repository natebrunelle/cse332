...
1. Think critically about assignment descriptions. We make every attempt to ensure that the assignment specifications are sufficient to complete each task. It may be the case, however, that some interpretation on your part is required to determine how to apply the relevant concepts from class. If there are cases where you perceive the assignment requirements as ambiguous, first reason carefully about all potential interpretations to see if you can rule any out. In most cases, only one interpretation is consistent with class content and/or the other requirements of the assignment.
