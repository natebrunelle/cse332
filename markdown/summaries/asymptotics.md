...
<img src="summaries/files/x2sinx.png" alt="A chart plotting $f(n)=|n^2 \sin(n)| and g(n)=10n. It shows that the $f(n)$ has peaks matching $n^2$ and valleys matching $0$, so neither function asymptotically overtakes the other." height="200"/>